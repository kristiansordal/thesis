...
\HRule \\[0.5cm]
\begin{Huge}
	\bfseries{Performance of Distributed and Shared Memory Parallel Sparse Matrix Vector Multiplication}\\[0.7cm] % Title of your document
\end{Huge}
\HRule \\[0.5cm]
...
\large \emph{Author:} Kristian S\o rdal\\
\large \emph{Supervisor:} Johannes Langguth\\
\large \emph{Co-Supervisor:} Fredrik Manne\\[2cm]
