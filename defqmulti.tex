...
Figure \ref{fig:tcompdefqmpimulti} and \ref{fig:tcommdefqmpimulti} illustrate the computation time and communication time for each iteration of SpMV, respectively. We can observe that the computation time decreases as the number of nodes increases, which is expected. As was the case for Figure \ref{fig:tcommdefqmulti} Strategy E performs worse, but does exhibit trends in decreasing the communication time as the number of nodes increases.
