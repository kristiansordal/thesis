...
The experiments that have been ran use three different high‐performance computing systems. \autoref{tab:hardware} gives an overview of the hardwares and their specifications that has been used in the experiments.
