...
The results in this section present the performance metrics of the communication strategies when ran on a single node containing two \defq{} chips. Each communication strategy has been ran using \(1,2,4,8,16,32,64\) MPI ranks for each communication strategy.
\medskip

\input{defqsingle}

\section{\defq{} - Multi Node Performance}
