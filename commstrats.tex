...
Table \ref{tab:commstrats} gives an overview of the reductions in communication strategies described in the previous sections. As the graph in Figure \ref{fig:examplegraph} is very small, this table doesn't illustrate the full potential of any of the strategies, but it does show that the communication volume is reduced for each strategy. 
...
\begin{table}[H]
    \begin{center}
        ...
        \end{tabular}
    \end{center}
    \caption{Overview of communication volume reduction for strategy A-D using graph in Figure \ref{fig:examplegraph}.}
