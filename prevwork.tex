...
SpMV is a widely reasearched topic within the field of high performance computing, as it is an operation which appears in a wide range of scientific domains. Efforts include the optimization of the performance of SpMV on different architectures, such as CPUs, GPUs, FPGAs and most recently IPUs. Effort has also been put into developing and testing various storage formats, testing the difference between various partitioning methods, and the effect that reordering matrices have on performance.
\medskip
